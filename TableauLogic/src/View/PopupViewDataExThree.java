...
public class PopupViewDataExThree extends JFrame {

	
	public PopupViewDataExThree(ArrayList<String[]> mistakes, ArrayList<String> correctAnswers, int numberOfColumns) {
